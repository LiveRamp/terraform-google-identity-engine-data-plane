...
| <a name="input_enable_liveramp_query_engine"></a> [enable\_liveramp\_query\_engine](#input\_enable\_liveramp\_query\_engine) | Create HMAC keys for LiveRamp's Query Engine to be used in data plane, should be enabled only to access LiveRamp data | `bool` | `false` | no |
